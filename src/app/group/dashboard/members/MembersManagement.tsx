...
export default function MembersManagement({
    ...
    return (
        <DashboardShell groupName={groupName} currentRole={currentRole} userName={userName}>
            ...
            <div className="md:hidden space-y-2.5">
                {filteredMembers.length === 0 ? (
                    ...
                    filteredMembers.map((member) => {
                        ...
                        const contactPhone = member.member_phone || member.emergency_contact_phone || member.father_phone || member.mother_phone
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start justify-between gap-2">
                                    ...
                                    <span
                                        className={`text-[9px] font-black px-2 py-0.5 rounded-full shrink-0 ${member.is_active
            ...
            {selectedMember && (
                <div data-modal="true" className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-xs overflow-y-auto">
