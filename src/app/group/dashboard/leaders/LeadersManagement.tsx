  ...
  return (
    <DashboardShell groupName={groupName} currentRole={currentRole} userName={userName}>
        {statusMessage && (
          ...
          <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-3">
            <div>
              <h2 className="text-xl sm:text-2xl font-black tracking-tight text-slate-900">Leadership Directory</h2>
            </div>
            {canManage && (
              <button
                onClick={() => {
