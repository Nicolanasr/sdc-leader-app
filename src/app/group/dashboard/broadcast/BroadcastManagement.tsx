    ...
    <DashboardShell groupName={groupName} currentRole={currentRole} userName={userName}>
      <div className="max-w-7xl mx-auto space-y-6 pb-12">
        ...
        <div className="bg-gradient-to-r from-teal-900 via-teal-800 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
          <div className="absolute right-0 top-0 translate-x-8 -translate-y-8 w-64 h-64 bg-teal-600/20 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 space-y-3">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-black bg-amber-400/20 text-amber-300 border border-amber-400/30">
                ...
                <span>Commandement du Groupe (قيادة الفوج)</span>
              </span>
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md text-[11px] font-bold bg-teal-950/60 text-teal-200">
                <Smartphone className="h-3 w-3" />
                <span>Evolution API & Telegram Active</span>
              </span>
            </div>

            <h1 className="text-2xl sm:text-3xl font-black tracking-tight">
              WhatsApp Broadcast & Communications Center
            </h1>
            <p className="text-sm text-teal-100/90 max-w-2xl leading-relaxed">
              Official command communication console for <strong>Chef de Groupe</strong> and <strong>Assistant</strong>. Broadcast official directives, camp briefs, and alerts to leaders or parents.
            </p>
          </div>
        </div>
        ...
        {statusMessage && (
          <div
            className={`p-4 rounded-2xl flex items-center gap-3 border text-sm font-bold shadow-sm animate-in fade-in slide-in-from-top-2 duration-200 ${
                            ...
                            <div className="flex items-center gap-2.5 min-w-0">
                              <div
                                className={`w-5 h-5 rounded-md flex items-center justify-center transition-colors shrink-0 ${
                                  isSelected ? 'bg-teal-800 text-white' : 'border border-slate-300 bg-white'
                                }`}
                              >
