          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Plan camps, hikes, view interactive calendar, and sync live to leaders' mobile phone calendars.
              </p>
            </div>
          ...
          {viewMode === 'calendar' && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4 mb-8">
              <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                <h3 className="text-base font-bold text-slate-900">Interactive Leaders Event Calendar</h3>
                <span className="text-xs text-slate-400 font-semibold">Click any event to open workspace</span>
              </div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <div className="flex items-center gap-1.5">
                          <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${
                            ev.scope === 'group' ? 'bg-teal-100 text-teal-800' : 'bg-amber-100 text-amber-800'
                          }`}>
